...
<!--<img src="background.jpg" style="width:1024px;height:50px;">-->
	...
	<div id="main-wrapper">
		<center>
			<h2>Offer something to your neighbours</h2>
			<img src="imgs/avatar1.png" class="avatar"/>
		</center>
	
		<form class="myform" action="addathing.php"method="post">
...
<!--			<a href="index.php"><input type="button" id="back_btn" value="Back"/></a> -->
		...
		<?php
			...
			//	{
				...
				//	else
				//	{
						$query= "insert into thing values('$description','$category','$state','$id')";
						$query_run = mysqli_query($con,$query);
						
						if($query_run)
						{
				//			echo '<script type="text/javascript"> alert("User Registered.. Go to login page to login") </script>';
							echo '<script type="text/javascript"> alert("Thing is added") </script>';
						}
						else
						{
